...
Session session = Session.getDefaultInstance(props, new Auth());
  ...
  try
  {
    ...
    message.setFrom(new InternetAddress("you@gmail.com", "You"));

    // Who is this message to (we could do fancier things like make a list or add CC's)
    message.setRecipients(Message.RecipientType.TO, InternetAddress.parse("yourfriends@whatever.com, andmore@whatever.com", false));

    // Subject and body
    message.setSubject("Lindy feels "+ amount +" "+ feeling);
    message.setText("And now you know how she feels at " + h + m + s);
